...
import { LayoutDashboard, PlusCircle, FileText, Settings, Zap, Globe, Bot, CheckSquare, Image, BookOpen, Search } from 'lucide-react';
...
const navItems = [
  ...
  { to: '/create-true-story', icon: Search, label: 'Tạo bài chuyện có thật' },
